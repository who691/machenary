...
if (isset( $_POST['submit']))
{
 ...
 if ( $sub_category==76) {
  ...
  $sub_category="Send Us The File";
    ...
    $query=mysqli_query( $conn, "insert into buycar(absection,typ,subcategory,supcategory,semicategory,
    acondition,loc,location,ye,year,hours,weight,fu,fule,cyl,cylinder,tra,transmission,col,color,cc,price,number,image,imagename)
