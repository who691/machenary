...
if( $sup_category==17){
 ...
 $query=mysqli_query( $conn, "insert into sell1(absection,typ,subcategory,supcategory,semicategory,
condition,loc,location,ye,year,hours,weight,fu,fule,cyl,cylinder,tra,transmission,col,color,cc,price,number,image,imagename)
