...
<h5 class="form-title text-center mb-3" style="margin-bottom: -15px; text-shadow: 10px 5px 5px #6db9ef; color:red;">ለመሸጥ አስፈላጊ መረጃዎቹን <span class="gold">ይሙሉ</span></h5>
  ...
  Color/ ቀለም
      ...
      <option value="0">Enter Your Own</option>
          ...
          <input class="input form-control" type="text" name="cc" 
            ...
            placeholder="Price not including Vat(ዋጋው ቫትን ሳይጨምር)"
             style="border-radius: 45px; box-shadow: 10px 5px 5px #6db9ef;"/>
...
<label for="files" class="btn" style=" line-height: 20px; border-radius: 45px; color: rgb(255, 217, 0); width: 13px; color: ivory;">
                ከቀረጥ ነፃ ለመሸጥ መሟላት ያለበት <br> <span style="background-color: black ; background-color: indigo;"> 
                  የብቃት ማረጋገጫ ቦሎ,ጂክላራሲዮን,ሊብሬ,የገቢዎች ክሊራንስ የቀረጥ ነፃ ደብዳቤ እና ኢንቨሰትመንት ፍቃድ ያስገቡ </span> </label>
            <input class="input form-control" id="files" style="visibility:hidden; border-radius: 45px; box-shadow: 10px 5px 5px #6db9ef;" type="file" name="image" >
        

           
            <div class="text-center mt-3" style="margin-top: -25px;"> <button type="submit" name="submit" value="submit" id="submit">Submit(አስገባ)</button></div>
  ...
  class="container-fluid frame">
    ...
    <h2 class="text-center white b-gray w-100"><span class="gold ">መሸጥ  </span>  ሚፈልጉትን መኪና በ 3 መንገድ ይሽጡ  </h2>
    ...
    <div class="row white justify-content-center py-0">
      <div class="rectangle b-l-gray">
        ...
        <p class="mx-2 text-left d-md-block d-none">መረጃዎን ያስገቡ.<br> በፍጥነት ገዢ እናገናኞታለን.</p>
      </div>
      <div class="rectangle b-l-gray">
        ...
        <p class="mx-2 text-left d-md-block d-none">መረጃዎን በቴሌ-ግራም ከላኩልን<br> በፍጥነት ገዢ እናገናኞታለን</p>
      </div>
      <div class="rectangle b-l-gray ">
        ...
        <p class="mx-2 text-left d-md-block d-none"> <br>ያግኙን በፍጥነት ገዢ እናገናኞታለን </p>
      </div>
    </div>
  </section>
  <!--Footer Section-->
...
$.get('ddck1.php',{'cata_id':cata_id},function(return_data){
  ...
  $("#sub-category").append("<option disabled selected hidden>-- Select Type --</option>")
...
$.get('ddck.php',{'cat_id':cat_id},function(return_data){
  ...
  $("#sup-category").append("<option disabled selected hidden>-- Select Brand --</option>")
